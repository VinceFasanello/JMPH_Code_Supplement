...
# Latitude -----------------------------------------------------
newdata$lat_range_pair_mean <- mean(newdata$lat_range_sp1, newdata$lat_range_sp2)
newdata$lat_mean_pair <- mean(newdata$centroid_lat_sp1, newdata$centroid_lat_sp2)
# newdata$lon_range_pair_mean <- mean(newdata$lon_range_sp1, newdata$lon_range_sp2)
newdata$lon_mean_pair <- mean(newdata$centroid_lon_sp1, newdata$centroid_lon_sp2)

# elevation
newdata$ele_range_pair_mean <- mean(newdata$ele_range_sp1, newdata$ele_range_sp2)
newdata$lat_mean_pair_ele_c25 <- mean(pairdata$centroid_lat_sp1_ele_c25)
# newdata$lat_mean_pair_ele_c12.5 <- mean(pairdata$centroid_lat_sp1_ele_c12.5)
newdata$lat_mean_pair_ele_c0 <- mean(pairdata$centroid_lat_sp1_ele_c0)
newdata$lon_mean_pair_ele_c25 <- mean(pairdata$centroid_lon_sp1_ele_c25)
# newdata$lon_mean_pair_ele_c12.5 <- mean(pairdata$centroid_lon_sp1_ele_c12.5)
newdata$lon_mean_pair_ele_c0 <- mean(pairdata$centroid_lon_sp1_ele_c0)

# MAT
# new new new ---------
newdata$tas_range <- mean(c(newdata$mean_MATr_sp1, newdata$mean_MATr_sp2))
newdata$tas_mean <- mean(c(newdata$mean_MAT_sp1, newdata$mean_MAT_sp2))
# ---------------------
newdata$MAT_range_pair_mean <- mean(newdata$MAT_range_sp1, newdata$MAT_range_sp2)  #UPDATE THIS LINE (TAS RANGE)
# ADD LINE HERE FOR TAS MEAN. 
newdata$lat_mean_pair_MAT_c25 <- mean(pairdata$centroid_lat_sp1_MAT_c25)
# newdata$lat_mean_pair_MAT_c12.5 <- mean(pairdata$centroid_lat_sp1_MAT_c12.5)
newdata$lat_mean_pair_MAT_c0 <- mean(pairdata$centroid_lat_sp1_MAT_c0)
newdata$lon_mean_pair_MAT_c25 <- mean(pairdata$centroid_lon_sp1_MAT_c25)
# newdata$lon_mean_pair_MAT_c12.5 <- mean(pairdata$centroid_lon_sp1_MAT_c12.5)
newdata$lon_mean_pair_MAT_c0 <- mean(pairdata$centroid_lon_sp1_MAT_c0)

# VarT
newdata$VarT_range_pair_mean <- mean(newdata$VarT_range_sp1, newdata$VarT_range_sp2)
newdata$lat_mean_pair_VarT_c25 <- mean(pairdata$centroid_lat_sp1_VarT_c25)
# newdata$lat_mean_pair_VarT_c12.5 <- mean(pairdata$centroid_lat_sp1_VarT_c12.5)
newdata$lat_mean_pair_VarT_c0 <- mean(pairdata$centroid_lat_sp1_VarT_c0)
newdata$lon_mean_pair_VarT_c25 <- mean(pairdata$centroid_lon_sp1_VarT_c25)
# newdata$lon_mean_pair_VarT_c12.5 <- mean(pairdata$centroid_lon_sp1_VarT_c12.5)
newdata$lon_mean_pair_VarT_c0 <- mean(pairdata$centroid_lon_sp1_VarT_c0)

# pcp
# new new new ---------
newdata$pcp_range <- mean(c(newdata$mean_pcpr_sp1, newdata$mean_pcpr_sp2))
newdata$pcp_mean <- mean(c(newdata$mean_pcp_sp1, newdata$mean_pcp_sp2))
# ---------------------
...
# newdata$centroid_distance_ele_c12.5 <- raster::pointDistance(c(pairdata$centroid_lon_sp1_ele_c12.5[1],pairdata$centroid_lat_sp1_ele_c12.5[1]), c(pairdata$centroid_lon_sp1_ele_c12.5[2],pairdata$centroid_lat_sp1_ele_c12.5[2]), lonlat = T)
...
# newdata$centroid_distance_MAT_c12.5 <- raster::pointDistance(c(pairdata$centroid_lon_sp1_MAT_c12.5[1],pairdata$centroid_lat_sp1_MAT_c12.5[1]), c(pairdata$centroid_lon_sp1_MAT_c12.5[2],pairdata$centroid_lat_sp1_MAT_c12.5[2]), lonlat = T)
...
# newdata$centroid_distance_VarT_c12.5 <- raster::pointDistance(c(pairdata$centroid_lon_sp1_VarT_c12.5[1],pairdata$centroid_lat_sp1_VarT_c12.5[1]), c(pairdata$centroid_lon_sp1_VarT_c12.5[2],pairdata$centroid_lat_sp1_VarT_c12.5[2]), lonlat = T)
...
# boundary length
newdata$boundary_length_ele_c25 <- mean(pairdata$boundary_length_sp1_ele_c25[1], pairdata$boundary_length_sp1_ele_c25[2])
...
# Latitude -----------------------------------------------------
  ...
  newdata$tas_mean <- mean(c(newdata$mean_MAT_sp1, newdata$mean_MAT_sp2))
  # ---------------------
  newdata$MAT_range_pair_mean <- mean(newdata$MAT_range_sp1, newdata$MAT_range_sp2) # UPDATE THIS LINE
  newdata$lat_mean_pair_MAT_c25 <- mean(pairdata$centroid_lat_sp1_MAT_c25)
  # newdata$lat_mean_pair_MAT_c12.5 <- mean(pairdata$centroid_lat_sp1_MAT_c12.5)
  newdata$lat_mean_pair_MAT_c0 <- mean(pairdata$centroid_lat_sp1_MAT_c0)
  newdata$lon_mean_pair_MAT_c25 <- mean(pairdata$centroid_lon_sp1_MAT_c25)
...
for (i in 1:length(mypairdata$Realm1)) {
    mypairdata$Realm1[i] <- extract(x = new_spdf, y = matrix(data = c(mypairdata$centroid_lon_sp1[i], mypairdata$centroid_lat_sp1[i]), nrow = 1))

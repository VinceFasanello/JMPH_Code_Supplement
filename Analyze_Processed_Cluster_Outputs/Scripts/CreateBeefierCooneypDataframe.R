...
for (i in 1:nrow(cooney)) {
  ...
  cooney$ele_range_sp1[i] <- abs(cooney$min_ele_sp1[i] - cooney$max_ele_sp1[i]) + 0.5 # range -----
  cooney$ele_range_sp2[i] <- abs(cooney$min_ele_sp2[i] - cooney$max_ele_sp2[i]) + 0.5
  ...
  cooney$MAT_range_sp1[i] <- abs(cooney$min_MAT_sp1[i] - cooney$max_MAT_sp1[i]) + 0.5 # range -----
  cooney$MAT_range_sp2[i] <- abs(cooney$min_MAT_sp2[i] - cooney$max_MAT_sp2[i]) + 0.5
  ...
  cooney$VarT_range_sp1[i] <- abs(cooney$min_VarT_sp1[i] - cooney$max_VarT_sp1[i]) + 0.5 # range -----
  cooney$VarT_range_sp2[i] <- abs(cooney$min_VarT_sp2[i] - cooney$max_VarT_sp2[i]) + 0.5

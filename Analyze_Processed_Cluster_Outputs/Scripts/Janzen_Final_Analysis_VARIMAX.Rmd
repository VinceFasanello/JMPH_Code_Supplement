...
myPCA <- principal(mydata[,c('tas_breadth', 'tas_position', 'pcp_breadth',
                             ...
                             'boundary_length')], nfactors = 9, rotate = "varimax")
myPCA$loadings
...
mydata$RC1 <- myPCA$scores[,'RC1']
mydata$RC7 <- myPCA$scores[,'RC7']
mydata$RC5 <- myPCA$scores[,'RC5']
mydata$RC3 <- myPCA$scores[,'RC3']
mydata$RC2 <- myPCA$scores[,'RC2']
mydata$RC6 <- myPCA$scores[,'RC6']
mydata$RC4 <- myPCA$scores[,'RC4']
mydata$RC8 <- myPCA$scores[,'RC8']
mydata$RC9 <- myPCA$scores[,'RC9']
...
for (i in sample(x = 1:length(trees), size = 1)) {
  ...
  mymod <- phylolm(I(log(cost)) ~ RC1 + RC7 + RC5 + RC3 + RC2 + RC6 + RC4 + RC8 + RC9,

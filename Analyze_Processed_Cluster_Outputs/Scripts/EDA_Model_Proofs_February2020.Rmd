...
mydata$thermal_niche_breadth <- mydata$MAT_range_pair_mean # mydata[,paste0(costvar, "_range_pair_mean")]
mydata$thermal_niche_position <- rowMeans(cbind(mydata[, paste0("mean_", "MAT" ,"_sp1")], mydata[, paste0("mean_","MAT","_sp2")]))

...
# MEAN TEMPERATURE -------------------------------------------------------------
setwd("~/Box Sync/JMPH_2020/data/CCSM4") # # read ncdf file with raw data
...
Month01_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month02_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month03_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month04_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month05_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month06_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month07_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month08_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month09_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month10_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month11_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
Month12_MeanT <- as.data.frame(matrix(NA, 192,288)); row.names(MeanT) <- lat_t; colnames(MeanT) <- lon_t
...
# Create rasters -------------------------------------------
inwd <- "~/Box Sync/JMPH_2020/data/Batch_Run"; setwd(inwd); load(file = "rasterpam.Rdata")
for (i in c("Month01", "Month02", "Month03", "Month04", "Month05", "Month06", 
  ...
  temp <- projectRaster(temp, rasterpam)
...
Month01_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month02_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month03_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month04_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month05_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month06_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month07_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month08_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month09_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month10_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month11_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
Month12_MaxT <- as.data.frame(matrix(NA, 192,288)); row.names(MaxT) <- lat_t; colnames(MaxT) <- lon_t
...
Month01_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month02_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month03_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month04_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month05_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month06_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month07_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month08_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month09_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month10_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month11_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
Month12_MinT <- as.data.frame(matrix(NA, 192,288)); row.names(MinT) <- lat_t; colnames(MinT) <- lon_t
